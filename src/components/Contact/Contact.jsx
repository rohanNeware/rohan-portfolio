        ...
        <section id="Contact" className="bg-[#f6f3fc] py-10">
            <div className="container mx-auto px-4 md:px-0 overflow-hidden">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-lg transition-transform duration-300 transform hover:scale-95 hover:shadow-xl hover:bg-[#2a1454] hover:text-white mx-0 my-4">
                    ...
                    <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-lg transition-transform duration-300 transform hover:scale-95 hover:shadow-xl hover:bg-[#2a1454] hover:text-white group mx-0 my-4">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center space-x-4">
                                ...
                                <a href="mailto:rohannewarw@gmail.com" className="text-lg text-gray-700 group-hover:text-white break-all">rohannewarw@gmail.com</a>
                            </div>
                            <div className="flex items-center space-x-4">
