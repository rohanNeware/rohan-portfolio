        ...
        <section id="Contact" className="bg-[#f6f3fc] py-10">
            <div className="container mx-auto px-4 md:px-0">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-[#2a1454] hover:text-white">
                    ...
                    <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-[#2a1454] hover:text-white group">
